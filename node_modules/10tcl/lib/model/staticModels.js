...
module.exports = function(){
	...
	var modelFunctions = {
		getAll: function( callback, tenant ){
			if (callback) callback( undefined, this )
			return this
		},

		getById: function( id, callback, tenant ){
			if (callback) callback( undefined, this.find({_id: id}) )
			return this.find({_id: id})
		},

		getByQuery: function( text, callback, tenant ){
			var regex = new RegExp( text, 'i')
			callback( undefined, this.find({desc: regex}) )
		},

		options: function( query, optionsCallback ){
			var self = this
			  , options = []
	        ...
	        optionsCallback( undefined, options)
		}
	}
